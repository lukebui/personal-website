  ...
  >
    <div class="relative mt-1 rounded-md shadow-sm">
      <input
        v-model="value"
        :id="localId"
        class="block w-full rounded-md shadow-sm disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500 sm:text-sm"
        :class="{
          'pr-9': type === 'password',
      ...
      <div class="absolute inset-y-0 right-0 flex items-center">
        <button
          type="button"
          v-if="type === 'password'"
          class="inline-flex items-center rounded-md border border-transparent p-2 text-white shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:cursor-not-allowed"
